...
<script src='js/GoodsView.js'></script>
   ...
   <form id="goodsForm"   method="post" >
            	 ...
            	 <table border="0" >
            	 	...
            	 	<tr>
            	 		<td style="padding-top: 0px;color: #BDBDBD">
            	 			...
            	 			访问量:<span id="chicknum"  style="font-size: 14px;padding-left: 7px;"></span>
            	 		</td>
            	 	</tr>
            	 	<tr>
            ...
            <div  id="tabbox" style="height: auto;width: 100%;border-top: 0px solid #ddd;margin-top: 0px;">
	            <ul class="tabs" id="tabs" style="width: 100%;text-align: center;">
	               <li class="tabsli" style="width: 20%"></li>
			       <li class="tabsli" id="lia1" style="width: 30%"><a  href="#" tab="tab1"  onclick="showClick('lia1','tab1')">商品详细</a></li>
			       <li class="tabsli" id="lia2" style="width: 30%"><a  href="#" tab="tab2"  onclick="showClick('lia2','tab2')">规格明细</a></li>
			       <li class="tabsli" style="width: 20%"></li>
			     </ul>
			     <div class="backDiv"></div>
			    <ul class="tab_conbox">
	...
	<div style="cleat:both; margin-top:50px;"></div>
    <div id="bespeakBtn"  class="butndiv">
    	<table border="0" style="width: 100%">
    		<tr>
    			<td align="center" style="border-right: 1px solid #ddd;" onclick="backOrg()">查看医院</td>
    			<td align="center" onclick="bespeak()">立即预约</td>
    		</tr>
    	</table>
    </div>
</body>
