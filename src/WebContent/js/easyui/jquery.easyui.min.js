...
var _a4=_a3.options;
var bb=_a3.bb={};
var _a5=$(_a2).addClass("pagination").html("<div class=\"pagination-info\"></div><table cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr></tr></table>");
var tr=_a5.find("tr");
...
_65a(this,_758);
	...
	if(!data||data.length==0){
		try{
			var opts = jq.data().datagrid.options;
			if(opts&&opts.columns.length>0){
				  var row=document.createElement("tr");  
			      //row.id=i;
			      var cell=document.createElement("td");  
			      cell.innerHTML = "<font color='#30a7e7' style='font-size:13px;'>没有查询结果</font>";
			      cell.id = jq.attr("id")+"_no_result";
			      cell.colSpan = opts.columns[0].length;
			      row.appendChild(cell);  
			      jq.prev().find("table.datagrid-btable tbody").get(0).appendChild(row);  
			}
		}catch(e){
