 ...
 * Generated at: 2015-11-20 08:03:37 UTC
...
public final class CallbackSearch_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/app/ejanton/callback/../../includeScript.jsp", Long.valueOf(1447697011984L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	//String uri = //获取当前页的url
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t<script src='js/CallbackSearch.js'></script>\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t<form id=\"callbackForm\" class='search-form' method=\"post\">\r\n");
      out.write("\t\t<table cellpadding=\"10\" >\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<table id=\"callbackTable\">\r\n");
      out.write("\t\t\t\t\t\t<tr >\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>患者姓名</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"normal-input\" type=\"text\" id=\"customerName\"  name=\"customerName\"></input>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"hidden\" id='customerId' data-ssbtype='int' name=\"customerId\" ></input>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>回访人</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t \t<input class=\"normal-input\" type=\"text\" id=\"followPersonel\"  name=\"followPersonel\" data-options=\"height:30\">\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- <td align='right' class='td-label'>回访方式</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input id='visitWay' class=\"easyui-combobox\" name=\"visitWay\" data-ssbtype='combobox' data-options=\"height:30,width:200,valueField:'dictValue',textField:'dictName',panelHeight:150\">\r\n");
      out.write("\t\t\t\t\t\t\t</td> -->\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>回访时间</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td colspan=\"2\"><input type=\"hidden\" id='visitTime' value='1'\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-ssbtype='dateRange' name=\"visitTime\"></input> <input\r\n");
      out.write("\t\t\t\t\t\t\t\tclass=\"easyui-datebox\" type=\"text\" id='visitTimeStart'\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tid='visitTimeEnd' data-ssbtype='date'\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"formatter:tcCoreformatter,parser:tcCoreParser,width:120,height:30,editable:false\"></input>\r\n");
      out.write("\t\t\t\t\t\t\t</td>   \r\n");
      out.write("  \t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<!--  <tr>\r\n");
      ...
      out.write("\t\t\t\t\t<a id=\"resetSearch\" class='easyui-linkbutton reset' onclick='resetSearch()'>重置</a>\r\n");
      out.write("\t\t\t\t\t<a id=\"queryDataBtn\"  href=\"#\" class=\"easyui-linkbutton search\" style='margin-left:10px;display:none;' data-options=\"iconCls:'icon-form-search-btn'\" onclick='queryCallback()'>查询</a>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</form>\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("\t<div id='callbackGridDiv' style='width: 100%'>\r\n");
      out.write("\t\t<table id='callbackGrid'></table>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div id=\"callbackGridPager\" />\r\n");
      out.write("\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>\r\n");
