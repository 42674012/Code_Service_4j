 ...
 * Generated at: 2015-11-04 02:23:53 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.app.ejanton.channel.manage;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class ManageEdit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/app/ejanton/channel/manage/../../../includeScript.jsp", Long.valueOf(1446121151261L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String context = request.getContextPath();
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t<script src='js/ManageEdit.js'></script>\r\n");
      out.write("\r\n");
      out.write("\t<div class=\"easyui-layout\" data-options=\"fit:true\">\r\n");
      out.write("\r\n");
      out.write("\t\t<div id='center' data-options=\"region:'center',border:false\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t<form id=\"manageForm\" class='edit-form' method=\"post\">\r\n");
      out.write("\t\t\t\t<div id='manageFormPanel' class='easyui-panel'\r\n");
      out.write("\t\t\t\t\tdata-options='headerCls:\"formHeaderCls\",bodyCls:\"formBodyCls\"'\r\n");
      out.write("\t\t\t\t\ttitle=\"渠道信息\" style=\"width: 100%; font-size: 13px;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tstyle=\"height: 21px;\"></input></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>渠道类型</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input class=\" easyui-combobox\" data-ssbtype=\"combobox\"\r\n");
      out.write("\t\t\t\t\t\t\t\ttype=\"text\" id=\"type\" name=\"type\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"height:30,valueField:'dictValue',textField:'dictName'\">\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>渠道负责人</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input id=\"manager\" ssbtype='autocomplete' type=hidden\r\n");
      out.write("\t\t\t\t\t\t\t\tname=\"manager\"></input> <input id=\"managerShow\"\r\n");
      out.write("\t\t\t\t\t\t\t\tstyle=\"height: 21px\"></input>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>状态</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input class=\"easyui-combobox\" type=\"text\" id=\"status\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-ssbtype='combobox' name=\"status\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"height:30,width:150,valueField:'dictValue',textField:'dictName'\">\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>组织机构</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input class=\" easyui-numberbox\" type=\"text\" id='orgId'\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-ssbtype='int' name=\"orgId\"\r\n");
      ...
      out.write("\t\t\t\t\tdata-options=\"iconCls:'icon-form-dustbin'\" onclick='deleteManage()'>删除</a>\r\n");
      out.write("\t\t\t\t<a id='addBtn' class=\"easyui-linkbutton oper\"\r\n");
      out.write("\t\t\t\t\tstyle='margin-left: 10px; margin-right: 10px;'\r\n");
      out.write("\t\t\t\t\tdata-options=\"iconCls:'icon-form-ok'\" onclick='saveManage()'>保存</a>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\r\n");
