 ...
 * Generated at: 2015-11-20 01:09:01 UTC
...
public final class HistoryView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	//String uri = //获取当前页的url
      ...
      out.write("</html>\n");
      out.write("\r\n");
      out.write("\t<link rel=\"stylesheet\" type=\"text/css\" href=\"styles/History.css\">\r\n");
      out.write("\r\n");
      out.write("\t<script src=\"");
      out.print(context);
      out.write("/js/easyui/plugin/datagrid-detailview.js\"></script>\r\n");
      out.write("\t\r\n");
      out.write("\t<script src=\"");
      out.print(context);
      out.write("/app/ejanton/history/js/HistoryCommon.js\"></script>\r\n");
      out.write("\t\r\n");
      out.write("\t<script src='js/HistoryView.js'></script>\r\n");
      out.write("\r\n");
      out.write("\t<div class=\"easyui-layout\" data-options=\"fit:true\">\r\n");
      out.write("\t\t<div id='center' data-options=\"region:'center',border:false\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t<form id=\"historyForm\" class='view-form' method=\"post\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<div id='historyFormPanel' class='easyui-panel'\r\n");
      out.write("\t\t\t\t\tdata-options='headerCls:\"formHeaderCls\",bodyCls:\"formBodyCls\"'\r\n");
      out.write("\t\t\t\t\ttitle=\"\" style=\"width: 100%;\">\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t<table id=\"d\" >\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td width=\"80\" align=\"right\">姓名：</td>\r\n");
      out.write("\t\t\t\t\t\t<td width=\"100\"><label id='name' data-ssbtype='text' name=\"name\"></label></td>\r\n");
      out.write("\t\t\t\t\t\t<td  width=\"80\" align=\"right\">电话：</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label id='phone' data-ssbtype='text' name=\"phone\"></label></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td  width=\"80\" align=\"right\">性别：</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label id='sex' data-ssbtype='text' name=\"sex\"></label></td>\r\n");
      out.write("\t\t\t\t\t\t<td  width=\"80\" align=\"right\">年龄：</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label id='age' data-ssbtype='text' name=\"age\"></label></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td width=\"80\" align=\"right\">家族病史：</td>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"3\"><label id='familyhistory' data-ssbtype='text' name=\"familyhistory\"></label></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td width=\"80\" align=\"right\">过&nbsp;敏&nbsp;史：</td>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"3\"><label id='allergy' data-ssbtype='text' name=\"allergy\"></label></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td align='right' vAlign='top' width=\"80\">病历记录：</td>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"3\">\r\n");
      out.write("\t\t\t\t\t\t\t<div   id='electronicHistoryGrid'></div>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<!-- div id='operbtn' class='operbtn'>\r\n");
      out.write("\t\t\t\t\t\t<a href=\"#\" class=\"easyui-linkbutton\" onclick=\"addHistory()\">新增病历</a> \r\n");
      out.write("\t\t\t\t\t\t<a href=\"#\" class=\"easyui-linkbutton\" onclick=\"addCustomerRecord()\" style=\"margin-left:10px;\">新增预约</a>\r\n");
      out.write("\t\t\t\t\t</div -->\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\r\n");
      out.write("\r\n");
