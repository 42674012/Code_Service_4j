 ...
 * Generated at: 2016-01-30 04:52:25 UTC
...
public final class BespeakView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	//String uri = //获取当前页的url
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t<script src='js/BespeakView.js'></script>\r\n");
      out.write("\r\n");
      out.write("\t<div class=\"easyui-layout\" data-options=\"fit:true\">\r\n");
      out.write("\r\n");
      out.write("\t\t<div id='center' data-options=\"region:'center',border:false\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t<form id=\"bespeakForm\" class='view-form' method=\"post\">\r\n");
      out.write("\t\t\t\t<table cellspacing='10'>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t<div id='bespeakFormPanel' title=\"Bespeak信息\"\r\n");
      out.write("\t\t\t\t\t\tstyle=\"width: 100%; font-size: 13px;\"> \r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td align='right' class='td-label'>支付价格</td>\r\n");
      out.write("\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\" easyui-numberbox\" type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid='nowprice' data-ssbtype='int'\r\n");
      out.write("\t\t\t\t\t\t\t\tname=\"nowprice\" data-options=\"height:30,width:200,required:true,precision:2\"></input>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>    \r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td align='right' class='td-label'>预约电话</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label id='phone' data-ssbtype='text'\r\n");
      out.write("\t\t\t\t\t\t\tname=\"phone\"></label></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td align='right' class='td-label'>预约姓名</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label id='usrname' data-ssbtype='text'\r\n");
      out.write("\t\t\t\t\t\t\tname=\"usrname\"></label></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td align='right' class='td-label'>商品名称</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label id='goodsname' data-ssbtype='text'\r\n");
      out.write("\t\t\t\t\t\t\tname=\"goodsname\"></label></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td align='right' class='td-label'>商品价格</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label id='price' data-ssbtype='int'\r\n");
      out.write("\t\t\t\t\t\t\tname=\"price\"></label></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td align='right' class='td-label'>商品折扣</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label id='discount' data-ssbtype='int'\r\n");
      out.write("\t\t\t\t\t\t\tname=\"discount\"></label></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t <tr>\r\n");
      out.write("\t\t\t\t\t\t<td align='right' class='td-label'>规格明细</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label id='detail' data-ssbtype='text'\r\n");
      out.write("\t\t\t\t\t\t\tname=\"detail\"></label></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td align='right' class='td-label'>活动主题</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label id='subject' data-ssbtype='text'\r\n");
      out.write("\t\t\t\t\t\t\tname=\"subject\"></label></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td align='right' class='td-label'>活动价格</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label id='camprice' data-ssbtype='text'\r\n");
      out.write("\t\t\t\t\t\t\tname=\"camprice\"></label></td>\r\n");
      out.write("\t\t\t\t\t</tr>      \r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td align='right' class='td-label'>活动开始时间</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label id='begintime' data-ssbtype='date'\r\n");
      out.write("\t\t\t\t\t\t\tname=\"begintime\"></label></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td align='right' class='td-label'>活动结束时间</td>\r\n");
      out.write("\t\t\t\t\t\t<td><label id='endtime' data-ssbtype='date'\r\n");
      out.write("\t\t\t\t\t\t\tname=\"endtime\"></label></td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t      \r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t\t\tdata-options=\"iconCls:'icon-form-ok'\" onclick='saveBespeak()'>支付</a>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</body>\r\n");
