 ...
 * Generated at: 2016-01-04 02:22:04 UTC
...
public final class modifyPassword_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	//String uri = //获取当前页的url
      ...
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<input name=\"employeeId\" type=\"text\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'><font color='red'>*</font>原始密码</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input id='oldPassword' class=\"easyui-textbox\" type=\"password\" \r\n");
      out.write("\t\t\t\t\t\t\t\tdata-ssbtype='text' name=\"oldPassword\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"required:'required',height:30,width:200\" /></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><div id=\"show_msg\" style=\"color: red; display: none\">原密码输入错误!</div></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'><font color='red'>*</font>新密码</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input class=\"easyui-textbox\" type=\"password\"  id='nowPassword'\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-ssbtype='text' name=\"nowPassword\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"height:30,width:200,required:'required'\"></input>\r\n");
      out.write("\t\t\t\t\t\t\t</td><td><div id=\"show_msg1\" style=\"color: red; display: none\">新密码不能为空!</div></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'><font color='red'>*</font>确认密码</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input type=\"password\" class=\"easyui-textbox\"\r\n");
      out.write("\t\t\t\t\t\t\t\ttype=\"text\" title='初始密码123456' id='password' data-ssbtype='text'\r\n");
      out.write("\t\t\t\t\t\t\t\tname=\"password\"  \r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"height:30,width:200,required:'required'\"></input>\r\n");
      out.write("\t\t\t\t\t\t\t</td><td><div id=\"show_msg2\" style=\"color: red; display: none\">两次密码不一样!</div></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</form>\r\n");
