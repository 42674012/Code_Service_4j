 ...
 * Generated at: 2015-12-07 06:21:27 UTC
...
public final class EmployeeView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	//String uri = //获取当前页的url
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t<script src='js/EmployeeView.js'></script>\r\n");
      out.write("\r\n");
      out.write("\t<div class=\"easyui-layout\" data-options=\"fit:true\">\r\n");
      out.write("\r\n");
      out.write("\t\t<div id='center'\r\n");
      out.write("\t\t\tdata-options=\"region:'center',border:false,iconCls:'icon-ok'\">\r\n");
      out.write("\t\t\t<form id=\"employeeForm\" class='view-form' method=\"post\">\r\n");
      out.write("\t\t\t\t<div id='employeeFormPanel' title=\"Employee信息\"\r\n");
      out.write("\t\t\t\t\tstyle=\"width: 100%; font-size: 13px;\">\r\n");
      out.write("\t\t\t\t\t<table cellspacing='20'>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>姓名</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><label id='name' data-ssbtype='text' name=\"name\"/></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>手机</td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<td><label id='sex' name=\"sex\" data-ssbtype='text'>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>银行账户</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><label id='bankAccount' data-ssbtype='text' name=\"bankAccount\"></label></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>生日</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><label id='birthday' data-ssbtype='text' name=\"birthday\"></label></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>邮箱</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><label id='email' data-ssbtype='text' name=\"email\"></label></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>部门</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><label id='deptIdShow' data-ssbtype=\"text\" ></label>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>职务</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t \t<label id=\"job\" name=\"job\" data-ssbtype=\"text\"/>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t<div data-options=\"region:'south',split:true\" style=\"height: 32px;\">\r\n");
