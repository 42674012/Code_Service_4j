 ...
 * Generated at: 2015-11-27 05:52:15 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.app.ssb.dict;
...
public final class DictTypeTree_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/app/ssb/dict/../../includeScript.jsp", Long.valueOf(1448597232733L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	//String uri = //获取当前页的url
      ...
      out.write("\t<script src='js/DictTypeTree.js'></script>\r\n");
      out.write("\t<div id=\"cc\" class=\"easyui-layout\" data-options=\"fit:true\">\r\n");
      out.write("\t\t<div id='west' data-options=\"region:'west',border:false\" style=\"width: 250px; padding: 5px;\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t<ul id=\"dictTypeTree\">\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div id='center' data-options=\"region:'center',border:false\" style=\"padding: 5px;\">\r\n");
      out.write("\t\t\t<div id='dictTypeFormPanel' class='easyui-panel' title=\"字典类型信息\"\r\n");
      out.write("\t\t\t\tstyle=\"width: 100%; font-size: 13px;\"\r\n");
      out.write("\t\t\t\tdata-options=\"iconCls:'icon-form-edit'\">\r\n");
      out.write("\t\t\t\t<form id=\"dictTypeForm\" class='edit-form' method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t\ttype='hidden' id='dictTypeId' name='dictTypeId'>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tdata-options=\"height:30,width:200,required:'required',validType:'length[1,6]'\"></input></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>编码</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input class=\"easyui-textbox\" type=\"text\" id='code'\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-ssbtype='text' name=\"code\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"height:30,width:200\"></input></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>扩展字段</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input class=\"easyui-textbox\" type=\"text\" id='expand'\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-ssbtype='text' name=\"expand\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"height:30,width:200\"></input></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td></td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tonclick='deleteDictType()'>删除</a> <a id='addBtn'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"easyui-linkbutton oper\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tstyle='margin-left: 10px; margin-right: 10px;'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdata-options=\"iconCls:'icon-form-ok'\" onclick='saveDictType()'>保存</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div id='dictGridDiv' style='width: 100%;margin-top:5px;'>\r\n");
      out.write("\t\t\t\t<table id='dictGrid'></table>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div id=\"dictGridPager\" />\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
