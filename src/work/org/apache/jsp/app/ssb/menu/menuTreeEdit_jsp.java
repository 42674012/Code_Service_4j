 ...
 * Generated at: 2015-12-03 02:10:05 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.app.ssb.menu;
...
public final class menuTreeEdit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/app/ssb/menu/../../includeScript.jsp", Long.valueOf(1448597232733L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	//String uri = //获取当前页的url
      ...
      out.write("\t\t\t\t<form id=\"menuForm\" class='edit-form' method=\"post\">\r\n");
      ...
      out.write("\t\t\t\t\t\ttype='hidden' id='menuId' name='menuId'>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tdata-ssbtype='text' name=\"name\" data-options=\"height:30,required:'required',validType:'length[1,6]'\"></input></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>描述</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input class=\"easyui-textbox\" type=\"text\" id='rembo'\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-ssbtype='text' name=\"rembo\" data-options=\"height:30\"></input></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>URI</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input class=\"easyui-textbox\" type=\"text\" id='url'\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-ssbtype='text' name=\"url\" data-options=\"height:30\"></input></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>图标</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input class=\"easyui-textbox\" type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\tid='icon' data-ssbtype='text' name=\"icon\"\r\n");
      out.write("\t\t\t\t\t\t\t\tdata-options=\"height:30\"></input></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>显示</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input type='checkbox' data-ssbtype='checkbox'\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"visiable\" name=\"visiable\" data-checkvalue=\"1,0\"\r\n");
      out.write("\t\t\t\t\t\t\t\tchecked='true' /></td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<td align='right' class='td-label'>新窗口打开</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td><input type='checkbox' data-ssbtype='checkbox'\r\n");
      out.write("\t\t\t\t\t\t\t\tid=\"isBlank\" name=\"isBlank\" data-checkvalue=\"1,0\" checked='true' />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tonclick='deleteMenu()'>删除</a> <a id='addBtn'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"easyui-linkbutton oper\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tstyle='margin-left: 10px; margin-right: 10px;'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdata-options=\"iconCls:'icon-form-ok'\" onclick='saveMenu()'>保存</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
      out.write("\r\n");
