 ...
 * Generated at: 2016-01-22 02:24:37 UTC
...
public final class Commision_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	//String uri = //获取当前页的url
      ...
      out.write("\t\t\t\t\t\t<table id=\"\" cellspacing='2' style='width: 100%;padding-left: 100px;font-weight: bold;font-size: 1.1em'>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t计算公式：场内*变量+(1-变量)*场外=总佣金;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t场内佣金=总佣金*变量;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t场外佣金=总佣金*(1-变量);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<br/>场外佣金平均值=1/3=33;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<br/>分享后产生消费场外人员=场外佣金*(场外佣金平均值+递减值);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<br/>分享后产生消费场外人员父一级=场外佣金*场外佣金平均值;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<br/>分享后产生消费场外人员父二级=场外佣金*(场外佣金平均值-递减值);\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span style=\"font-size: 1pt;color: red\">注:填框内为百分比 取值0~100范围内的</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<br/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t变量=<input type=\"text\" id=\"bianliang\" class=\"easyui-numberbox\" style=\"width:70px\"  value=\"\" data-options=\"min:0,max:100,precision:0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t&nbsp;&nbsp;递减值=<input id=\"dijianzhi\" type=\"text\" class=\"easyui-numberbox\" style=\"width:70px\"  value=\"\" data-options=\"min:0,max:100,precision:0\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"easyui-linkbutton search\" style='margin-left:30px;'\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tdata-options=\"iconCls:'icon-form-search-btn'\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tonclick='queding()'>确定</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t<table id=\"showvarCode\" cellspacing='10' style='width: 100%'>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
